app.service('employeeService', function($http) {
  ...
  this.addEmployee = function(employee) {
    return $http.post(
      'http://localhost:9000/test-server/Employee/addEmployee',
      {
  ...
  this.getAllEmployees = function() {
    return $http.get(
      'http://localhost:9000/test-server/Employee/getAllEmployees'
    );
  };

  this.deleteEmployee = function(empId) {
    return $http.delete(
      'http://localhost:9000/test-server/Employee/removeEmployee?empId=' + empId
    );
  };
});
